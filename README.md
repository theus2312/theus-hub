                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script theus hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
setclipboard("theus hub Is The Best")
...
Tabs.Main:AddButton({
        Title = "theus hub Discord Server",
...
Fluent:Notify({
    Title = "theus hub",
    Content = "Thanks For Using theus hub",
    Duration = 8
})
